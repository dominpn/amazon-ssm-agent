...
// A step in the package configuration result.
type ConfigurePackageResultStep struct {
	...
	// The timing information for the step.
	Timing *int64
...
type InstanceAssociationSummary struct {
	...
	// A checksum for the association document.
	Checksum *string
...
// The result of the association execution.
